interface SettingsLogoProps extends React.SVGProps<SVGSVGElement> {}

export const SettingsLogo = ({ ...props }: SettingsLogoProps) => {
  return (
    <svg {...props} fill="white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" id="settings">
