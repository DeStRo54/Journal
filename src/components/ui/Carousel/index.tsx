...
const CarouselContent = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => {
    ...
    return (
      <div ref={carouselRef}>
        <div ref={ref} className={clsx(styles.CarouselContent, className)} {...props} />
      </div>
    );
  }
);
...
const Card = React.forwardRef<HTMLDivElement, customHTMLDivElementAttributes>(({ className, index, ...props }, ref) => {
